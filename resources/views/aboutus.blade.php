...
<head>
    ...
    <title>HackerShelf - About Us</title>
    ...
    <style>
        ...
        * {
        ...
        .logo {
            font-size: 20px;
            font-weight: 700;
            background: linear-gradient(90deg, #fff, #CA6E0A);
        ...
        .hero-section h1 {
            ...
            font-weight: 400;
            margin-bottom: 20px;
            background: linear-gradient(0deg, #fff, #CA6E0A);
            -webkit-background-clip: text;
            background-clip: text;
            color: transparent;
        }
        ...
        .divider {
            width: 100px;
            height: 2px;
            background: linear-gradient(90deg, #643705, #CA6E0A);
            margin: 0 auto 60px;
        }
    ...
    <main>
        <section class="hero-section">
            <div class="container">
                ...
                <div class="big-logo">
                    <img src="./public/assets/images/logo-apk-hci.png" class="logo-img">
