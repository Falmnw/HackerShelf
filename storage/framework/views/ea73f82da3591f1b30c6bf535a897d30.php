...
<link rel="stylesheet" href="<?php echo e(asset('assets/css/style-aboutus.css')); ?>">
<?php $__env->stopPush(); ?>
    ...
    <main>
        <section class="hero-section">
            <div class="container">
                ...
                <div class="big-logo">
                    <img src="<?php echo e(asset('assets/images/logo-apk-hci.png')); ?>" class="logo-img">
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Documents\Kuliah\Semester5\HCI\HackerShelf\resources\views/about.blade.php ENDPATH**/ ?>