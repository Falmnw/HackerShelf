...
<body>
    ...
    <div class="login-container">
        ...
        <form class ="login-form" id="login-form" action="<?php echo e(route('login')); ?>" accept-charset="UTF-8"  method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Documents\Kuliah\Semester5\HCI\HackerShelf\resources\views/login.blade.php ENDPATH**/ ?>